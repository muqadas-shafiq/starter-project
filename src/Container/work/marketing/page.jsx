...
export default function MarketWork(){
    ...
    return(
        ...
        <div className='pt-20 min-h-fit flex justify-center items-start  text-secondary flex-col lg:py-20 lg:pl-20 lg:w-[70%] w-full p-6'>
            ...
            <p className=' font-poppins pt-6'>Olumi developers create a tailored marketing solution to empower client businesses. We have already designed unique solutions to cater to the specific needs of each business to enhance their reach and boost sales by increased brand visibility.
            </p>
            <div  
