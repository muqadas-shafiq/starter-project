...
const HeroSection = () => {
  return (
    <div className='flex min-h-screen max-w-full  bg-black md:bg-black text-white justify-between items-center flex-col md:flex-row '>
        <div className='h-[50%] flex flex-col px-20 '>
           
            <h1 className='flex text-6xl font-bold mt-20'>Life is a <br /> combination <br /> of magic And pizza</h1>
        ...
        <div className=' min-h-[90%] bg-cover px-28'>
